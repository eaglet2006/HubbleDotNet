...
{
    class SP_UpdateDatabase : StoredProcedure, IStoredProc, IHelper
    {
        ...
        public string Help
        {
            get 
            {
                return "Update the attribute of database. Parameter 1 is Database name. Parameter 2 is DefaultPath, Parameter 3 is DefaultDBAdapter, Parameter 4 is DefaultConnectionString";
            }
        }
