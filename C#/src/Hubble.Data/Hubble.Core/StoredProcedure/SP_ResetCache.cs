...
{
    class SP_ResetCache : StoredProcedure, IStoredProc, IHelper
    {
        ...
        public string Help
        {
            get
            {
                return "Reset query cache and data cache for the specific table. Parameter 1 is table name.";
            }
        }
