...
{
    class SP_DisableTablet : StoredProcedure, IStoredProc, IHelper
    {
        ...
        public void Run()
        {
            ...
            OutputMessage(string.Format("Disable tablet:{0} of bigtable: {1} successul.",
        ...
        public string Help
        {
            get
            {
                return "Disable tablet of big table.  Parameter 1 is big table name, parameter 2 is tablet name, parameter 3 is server name (optional)";
            }
        }
