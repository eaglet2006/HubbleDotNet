...
{
    /// <summary>
    /// IntDictinary is a special dictinary for Int 
    /// Base arithmetic: Hash
    /// Like BTree
    /// </summary>
    /// <typeparam name="TValue">Value</typeparam>
    public class IntDictionaryBTree<TValue> : IDictionary<int, TValue>
    {
        enum Operator
        {
            Query = 0,
        ...
        {
            private IntDictionaryBTree<TValue> _Dictionary;

            public KeyCollection(IntDictionaryBTree<TValue> dictionary)
            {
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection
        {
            ...
            public ValueCollection(IntDictionaryBTree<TValue> dictionary)
            {
                _Dictionary = dictionary;
            }
        ...
        public IntDictionaryBTree(int maxChildren)
        {
            MaxChildren = maxChildren;
        }

        public IntDictionaryBTree()
            : this(2048)
        {
        }
